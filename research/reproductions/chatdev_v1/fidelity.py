...
class ChatDevV1ReferenceFidelity:
    ...
    non_reflection_overwrites_with_last_assistant: bool = True
    phase_chatting_strips_info_marker_before_return: bool = True
    code_review_break_requires_info_finished_marker: bool = True
    composed_break_checked_before_and_after_simple_phase: bool = True
    ...
    def __post_init__(self) -> None:
        ...
        if not all((
            self.non_reflection_overwrites_with_last_assistant,
            self.phase_chatting_strips_info_marker_before_return,
            self.code_review_break_requires_info_finished_marker,
            self.composed_break_checked_before_and_after_simple_phase,
        )):
            raise ValueError("ChatDev v1 phase/composed control semantics drifted")
