...
> Source Git SHA: `ccd6a0220e478eb2e1a32f9cc5276935341e765c`.
...
| `python_modules` | 2526 |
| `classes` | 3147 |
| `inheritance_edges` | 138 |
| `association_edges` | 3186 |
| `constructor_edges` | 856 |
| `module_import_edges` | 5463 |
...
flowchart LR
  ...
  T_C_1e2147459888 -->|"imports 8"| T_C_1e5dcbb59b75
  T_C_1e2147459888 -->|"imports 23"| T_C_c6e454d960df
  T_C_1e2147459888 -->|"imports 1"| T_C_56b8e6bb9574
  T_C_1e2147459888 -->|"imports 1"| T_C_1d06a0d76f00
  T_C_1e2147459888 -->|"imports 51"| T_C_7a2110450a94
  T_C_1e2147459888 -->|"imports 108"| T_C_3c72abbe626f
  T_C_1e2147459888 -->|"imports 28"| T_C_844e392a5d6c
  T_C_1e2147459888 -->|"imports 1"| T_C_aacd3103f3f1
  ...
  T_C_04bad6aedb36 -->|"imports 102"| T_C_3c72abbe626f
...
| `noetrium_platform.capabilities.environment.web.api.contracts` | `WebActionKind` | `enum` | `StrEnum` | 8 | 0 |
...
direction LR
  ...
  class C_6c5dbee31647["PublishedExecutableProgramSource"]
  <<dataclass>> C_6c5dbee31647
  class C_834bbd954e99["ExecutableProgramIdentity"]
  <<dataclass>> C_834bbd954e99
  class C_a96572bc7fc6["ProgramExecutionRequest"]
  <<dataclass>> C_a96572bc7fc6
  class C_65fa065dfce6["ExecutableProgramSourcePublicationPort"]
  <<protocol>> C_65fa065dfce6
  class C_7d07c90339f2["ProgramExecutionStatus"]
  <<enum>> C_7d07c90339f2
  class C_d8fe2214ba60["ProgramExecutionReceipt"]
  <<dataclass>> C_d8fe2214ba60
  class C_2e2c429d0d23["ProgramExecutionReconciliationDisposition"]
  <<enum>> C_2e2c429d0d23
  class C_b4d8262cdded["ProgramExecutionReconciliationResult"]
  <<dataclass>> C_b4d8262cdded
  class C_4cd930fa13e3["ProgramExecutionRecoveryPort"]
  <<protocol>> C_4cd930fa13e3
  class C_0b5952887a9b["ProgramExecutionPort"]
  <<protocol>> C_0b5952887a9b
  ...
  class C_9ea3bcb8e216["ArtifactExecutableProgramSourcePublisher"]
  <<dataclass>> C_9ea3bcb8e216
  class C_e3ec000e89b6["QualifiedProgramExecutionBinding"]
  ...
  class C_39c35eb00f98["ChildBatchExecutionMode"]
  <<enum>> C_39c35eb00f98
  class C_8cd14bc36d98["ChildResearchMachineBatchItem"]
  <<dataclass>> C_8cd14bc36d98
  class C_8189548b34ba["ChildResearchMachineBatchRequest"]
  <<dataclass>> C_8189548b34ba
  class C_ff7b941cbc55["ChildResearchMachineBatchMechanicsResult"]
  <<dataclass>> C_ff7b941cbc55
  class C_0947f762cf2e["ChildResearchMachineBatchPort"]
  <<protocol>> C_0947f762cf2e
  class C_6ff39ae97802["ChildResearchMachineBatchMechanicsPort"]
  <<protocol>> C_6ff39ae97802
  class C_cf199803cb5f["ChildResearchMachineBatchExecution"]
  <<dataclass>> C_cf199803cb5f
  class C_ea7bd3ca6f2b["ChildResearchMachineBatchExecutor"]
  class C_2c24f1b0b0f4["BatchCapableRegisteredChildResearchMachineExecutor"]
  class C_0409d613cc6f["ThreadPoolChildResearchBatchMechanics"]
  class C_a6fca3e14915["RegisteredSerialChildResearchBatchMechanics"]
  ...
  class C_97780dec4d43["ProgramExecutionCapabilityBinding"]
  ...
  C_6ff39ae97802 <|-- C_a6fca3e14915
  C_6ff39ae97802 <|-- C_0409d613cc6f
  ...
  C_8758e04f28b9 ..> C_6fb03d792952 : constructs
  C_9fcefa3ff1bb ..> C_d50047e525ae : constructs
  C_29c1a2b54834 ..> C_7658846d55f0 : constructs
  C_6fb03d792952 ..> C_9fcefa3ff1bb : constructs
  C_2c24f1b0b0f4 ..> C_ea7bd3ca6f2b : constructs
  C_ea7bd3ca6f2b ..> C_cf199803cb5f : constructs
  C_a6fca3e14915 ..> C_ff7b941cbc55 : constructs
  C_0409d613cc6f ..> C_ff7b941cbc55 : constructs
...
| `noetrium_platform.research.execution.api.program_execution` | `PublishedExecutableProgramSource` | `dataclass` | `` | 2 | 1 |
| `noetrium_platform.research.execution.api.program_execution` | `ExecutableProgramIdentity` | `dataclass` | `` | 7 | 1 |
| `noetrium_platform.research.execution.api.program_execution` | `ProgramExecutionRequest` | `dataclass` | `` | 10 | 1 |
| `noetrium_platform.research.execution.api.program_execution` | `ExecutableProgramSourcePublicationPort` | `protocol` | `Protocol` | 0 | 1 |
| `noetrium_platform.research.execution.api.program_execution` | `ProgramExecutionStatus` | `enum` | `StrEnum` | 3 | 0 |
| `noetrium_platform.research.execution.api.program_execution` | `ProgramExecutionReceipt` | `dataclass` | `` | 10 | 1 |
| `noetrium_platform.research.execution.api.program_execution` | `ProgramExecutionReconciliationDisposition` | `enum` | `StrEnum` | 4 | 0 |
| `noetrium_platform.research.execution.api.program_execution` | `ProgramExecutionReconciliationResult` | `dataclass` | `` | 4 | 1 |
| `noetrium_platform.research.execution.api.program_execution` | `ProgramExecutionRecoveryPort` | `protocol` | `Protocol` | 0 | 2 |
| `noetrium_platform.research.execution.api.program_execution` | `ProgramExecutionPort` | `protocol` | `Protocol` | 0 | 1 |
...
| `noetrium_platform.research.execution.composition.program_source` | `ArtifactExecutableProgramSourcePublisher` | `dataclass` | `` | 5 | 2 |
| `noetrium_platform.research.execution.composition.qualified_program_execution` | `QualifiedProgramExecutionBinding` | `class` | `` | 0 | 6 |
...
| `noetrium_platform.research.execution.machines.child_machine` | `ChildResearchHostRegistry` | `class` | `ChildResearchHostRegistryPort` | 0 | 7 |
...
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildBatchExecutionMode` | `enum` | `StrEnum` | 2 | 0 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildResearchMachineBatchItem` | `dataclass` | `` | 3 | 1 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildResearchMachineBatchRequest` | `dataclass` | `` | 6 | 1 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildResearchMachineBatchMechanicsResult` | `dataclass` | `` | 5 | 1 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildResearchMachineBatchPort` | `protocol` | `Protocol` | 0 | 2 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildResearchMachineBatchMechanicsPort` | `protocol` | `Protocol` | 0 | 2 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildResearchMachineBatchExecution` | `dataclass` | `` | 7 | 3 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ChildResearchMachineBatchExecutor` | `class` | `` | 0 | 3 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `BatchCapableRegisteredChildResearchMachineExecutor` | `class` | `` | 0 | 5 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `ThreadPoolChildResearchBatchMechanics` | `class` | `ChildResearchMachineBatchMechanicsPort` | 0 | 3 |
| `noetrium_platform.research.execution.machines.child_machine_batch` | `RegisteredSerialChildResearchBatchMechanics` | `class` | `ChildResearchMachineBatchMechanicsPort` | 0 | 3 |
...
| `noetrium_platform.research.execution.runtime.program_execution_capability` | `ProgramExecutionCapabilityBinding` | `class` | `` | 0 | 14 |
...
direction LR
  ...
  class C_2fd159925ee9["ExperimentShard"]
  <<dataclass>> C_2fd159925ee9
  class C_66f787325f97["ExperimentBatchPlacement"]
  <<dataclass>> C_66f787325f97
  class C_f292d52a46b8["CompiledExperimentShardPlan"]
  <<dataclass>> C_f292d52a46b8
  ...
  C_2a34d1097050 ..> C_b291360d4106 : constructs
...
| `noetrium_platform.research.experimentation.api.sharding` | `ExperimentShard` | `dataclass` | `` | 5 | 1 |
| `noetrium_platform.research.experimentation.api.sharding` | `ExperimentBatchPlacement` | `dataclass` | `` | 4 | 2 |
| `noetrium_platform.research.experimentation.api.sharding` | `CompiledExperimentShardPlan` | `dataclass` | `` | 7 | 6 |
...
| `noetrium_platform.research.experimentation.study.api.contracts` | `StudyConcurrencyPolicy` | `dataclass` | `` | 9 | 3 |
