...
def _content_ref_payload(ref: ContentRef | None) -> JsonObject | None:
    if ref is None:
        return None
    return {
        "sha256": ref.sha256,
...
def _content_ref(value: object) -> ContentRef:
    ...
    if frozenset(value) != {"sha256", "size_bytes", "media_type"}:
    ...
    return ContentRef(sha, size, media)
...
class AgentTurnModelFactRecorder:
    ...
    def __init__(self, facts: AgentTurnFactSink, content: ContentAddressedStorePort) -> None:
        self._facts = facts
