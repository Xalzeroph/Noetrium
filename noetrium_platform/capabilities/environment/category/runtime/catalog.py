...
def canonical_environment_categories() -> tuple[EnvironmentCategoryDescriptor, ...]:
    ...
    return (
        _category(
            ...
            ("minecraft.mineflayer", "minecraft.rcon", "minecraft.raw_control"),
        ),
        _category(
            ...
            ("embodied.adapter", "embodied.simulator"),
...
def canonical_environment_implementations() -> tuple[EnvironmentImplementationDescriptor, ...]:
    return (
        ...
        EnvironmentImplementationDescriptor(
            implementation_id="minecraft.raw_control",
            category_id=EnvironmentCategoryId.MINECRAFT,
            version="1",
            provider_package=_environment_family_descriptor(EnvironmentCategoryId.MINECRAFT).package_prefix,
            backend_kind="raw_pixel_keyboard_mouse",
            status=EnvironmentCategoryStatus.AVAILABLE,
            capabilities=("raw_pixels", "low_level_controls", "reward", "reconcile"),
            resource_profile={"supports": ["minerl", "vpt_style_backend"]},
        ),
        EnvironmentImplementationDescriptor(
        ...
        EnvironmentImplementationDescriptor(
            implementation_id="embodied.simulator",
            category_id=EnvironmentCategoryId.EMBODIED,
            version="1",
            provider_package=_environment_family_descriptor(EnvironmentCategoryId.EMBODIED).package_prefix,
            backend_kind="typed_simulator_backend",
            status=EnvironmentCategoryStatus.AVAILABLE,
            capabilities=("sensors", "actions", "trajectory", "reconcile"),
            resource_profile={"supports": ["simulator_backend"]},
        ),
        EnvironmentImplementationDescriptor(
