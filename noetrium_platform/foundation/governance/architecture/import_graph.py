...
DEFAULT_IMPORT_RULES=(
    ...
    ImportRule("noetrium_platform.infrastructure.lifecycle.launch_control","noetrium_platform.capabilities.participant.definition.runtime","Runtime Manager cannot import participant definition runtime"),
    ImportRule("noetrium_platform.infrastructure.lifecycle.launch_control","noetrium_platform.capabilities.participant.binding.runtime","Runtime Manager cannot import participant binding runtime"),
    ImportRule("noetrium_platform.infrastructure.lifecycle.launch_control","noetrium_platform.capabilities.participant.session.runtime","Runtime Manager cannot import participant session runtime"),
    ...
    ImportRule("noetrium_platform.infrastructure.lifecycle.session.runtime.","noetrium_platform.infrastructure.lifecycle.launch_control","Persistent-session implementation cannot depend upward on Runtime Manager"),
    ...
    ImportRule("noetrium_platform.infrastructure.lifecycle.launch_control","noetrium_platform.infrastructure.lifecycle.session.runtime.","Runtime Manager must depend on persistent-session API, not a concrete backend"),
