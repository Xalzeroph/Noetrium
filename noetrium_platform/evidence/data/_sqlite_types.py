...
def require_blob(value: object, *, label: str) -> bytes:
    if not isinstance(value, bytes):
        raise TypeError(f"{label} must be stored as SQLite BLOB")
    return value


__all__ = ["require_blob", "require_integer", "require_optional_text", "require_text"]
