...
from research.reproductions.rap_reasoning.source import SOURCE_OFFICIAL_RAP_REPO


def test_rap_source_and_role_fidelity_are_frozen() -> None:
    assert SOURCE_OFFICIAL_RAP_REPO.commit == "774817c228b3d5ddfc18de2318f3476128ecf6eb"
