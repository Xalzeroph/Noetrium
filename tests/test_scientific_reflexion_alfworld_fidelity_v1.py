...
def test_reflexion_alfworld_protocol_is_explicit() -> None:
...
def test_reflexion_action_candidate_admission_matches_source_retry_policy() -> None:
    ...
    with pytest.raises(ReflexionProtocolError, match="one line"):
...
def test_skipped_task_does_not_generate_reflection() -> None:
    ...
    with pytest.raises(ReflexionProtocolError, match="solved/skipped"):
        render_reflection_prompt(
