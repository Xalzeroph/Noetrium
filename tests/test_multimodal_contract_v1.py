...
def _ref(char: str, media_type: str) -> ArtifactBlobRef:
    return ArtifactBlobRef(char * 64, 10, media_type)
...
def test_method_metadata_is_frozen_and_part_identity_changes_with_temporal_context() -> None:
    ...
    assert part != shifted
    assert part.content.content_sha256 == shifted.content.content_sha256
